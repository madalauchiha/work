...
from services.IO_External import run_case
from common.comm_paras import CASE_XLS_PATH


case_params = get_selected_case_param(CASE_XLS_PATH, 'IO_External')
...
def test_IO_External(case_name, case_input, case_expect):
